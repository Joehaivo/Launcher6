...
public abstract class BaseFlags {
    ...
    public static final boolean LAUNCHER3_DISABLE_INTERACTIVE = "false".equals(Utilities.getSystemProperty("debug.launcher3.enable", "true"));
    ...
    public static final boolean QSB_ON_FIRST_SCREEN = !LAUNCHER3_DISABLE_INTERACTIVE && !LAUNCHER3_REMOVE_DRAWER;
